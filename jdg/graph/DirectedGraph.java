...
public class DirectedGraph {
	...
	public ArrayList<Pair<Node,Node>> edgelist; 
	public HashMap<Pair<Integer,Integer>,ArrayList<Pair<Node,Node>> > position_map = new HashMap<Pair<Integer,Integer>,ArrayList<Pair<Node,Node>> >();
	public boolean[][] grid ;
